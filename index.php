...
<div class="page-wrapper">
    ...
    <div class="loader-wrap">
        <div class="preloader"><div class="preloader-close">Schedanel Global</div></div>
        ...
        <div class="wrapper-box">
            <div class="content-wrapper">
                ...
                <div class="text-widget sidebar-widget">
                    ...
                    <div class="text">From will power is born. Success is the result of perfection, hard work, learning from failure, loyalty to those who we work for and persistence</div>
                </div>
                <!-- PDF Widget -->
                ...
                <div class="contact-widget">
                    <div class="icon-box">
                        ...
                        <div class="text">Makindye, Luwafu Road, <br> Kampala, Mak Division, UG.</div>
                    </div>
                    <div class="icon-box">
                        <div class="icon"><span class="flaticon-calling"></span></div>
                        <div class="text"><strong>Phone</strong><a href="tel:(+256)704368743">(+256) 704368743</a></div>
                    </div>
                    <div class="icon-box">
                        <div class="icon"><span class="flaticon-mail"></span></div>
                        <div class="text"><strong>Email</strong><a href="tel:(+256)704368743">supportyou@schedglobal.com</a></div>
                    </div>
                </div>
                <!-- Link Btn -->
    ...
    <section class="banner-section">
        ...
        <div class="background-text">
            <div data-parallax='{"x": 100}'>
                <div class="text-1">Schedanel</div>
                <div class="text-2">Schedanel</div>
            </div>                
        </div>
                            ...
                            <div class="inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                                <div class="content">
                                    ...
                                    <div class="count-outer count-box">
                                        <span class="count-text" data-speed="3000" data-stop="312">0</span>
                                    </div>
