...
! function(e, t) { void 0 === e && void 0 !== window && (e = window), "function" == typeof define && define.amd ? define(["jquery"], function(e) { return t(e) }) : "object" == typeof module && module.exports ? module.exports = t(require("jquery")) : t(e.jQuery) }(this, function(e) {
    ! function(F) {
        ...
        function z(e) { return parseInt(e, 10) || 0 }
        ...
        var h = function(t) {
            ...
            G = h({ "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#x27;", "`": "&#x60;" }),
            f = h({ "&amp;": "&", "&lt;": "<", "&gt;": ">", "&quot;": '"', "&#x27;": "'", "&#x60;": "`" }),
            S = { 32: " ", 48: "0", 49: "1", 50: "2", 51: "3", 52: "4", 53: "5", 54: "6", 55: "7", 56: "8", 57: "9", 59: ";", 65: "A", 66: "B", 67: "C", 68: "D", 69: "E", 70: "F", 71: "G", 72: "H", 73: "I", 74: "J", 75: "K", 76: "L", 77: "M", 78: "N", 79: "O", 80: "P", 81: "Q", 82: "R", 83: "S", 84: "T", 85: "U", 86: "V", 87: "W", 88: "X", 89: "Y", 90: "Z", 96: "0", 97: "1", 98: "2", 99: "3", 100: "4", 101: "5", 102: "6", 103: "7", 104: "8", 105: "9" },
            C = 27,
            O = 13,
            T = 32,
            D = 9,
        ...
        var p = 0,
            L = ".bs.select",
            q = { DISABLED: "disabled", DIVIDER: "divider", SHOW: "open", DROPUP: "dropup", MENU: "dropdown-menu", MENURIGHT: "dropdown-menu-right", MENULEFT: "dropdown-menu-left", BUTTONCLASS: "btn-default", POPOVERHEADER: "popover-title" },
            N = { MENU: "." + q.MENU };
        ...
        function v(e) {
            ...
            if ([].shift.apply(l), !_.success) {
                try { _.full = (F.fn.dropdown.Constructor.VERSION || "").split(" ")[0].split(".") } catch (e) { _.full = u.BootstrapVersion.split(" ")[0].split(".") }
        ...
        u.VERSION = "1.13.3", u.BootstrapVersion = _.major, u.DEFAULTS = { noneSelectedText: "Nothing selected", noneResultsText: "No results matched {0}", countSelectedText: function(e, t) { return 1 == e ? "{0} item selected" : "{0} items selected" }, maxOptionsText: function(e, t) { return [1 == e ? "Limit reached ({n} item max)" : "Limit reached ({n} items max)", 1 == t ? "Group limit reached ({n} item max)" : "Group limit reached ({n} items max)"] }, selectAllText: "Select All", deselectAllText: "Deselect All", doneButton: !1, doneButtonText: "Close", multipleSeparator: ", ", styleBase: "btn", style: q.BUTTONCLASS, size: "auto", title: null, selectedTextFormat: "values", width: !1, container: !1, hideDisabled: !1, showSubtext: !1, showIcon: !0, showContent: !0, dropupAuto: !0, header: !1, liveSearch: !1, liveSearchPlaceholder: null, liveSearchNormalize: !1, liveSearchStyle: "contains", actionsBox: !1, iconBase: "glyphicon", tickIcon: "glyphicon-ok", showTick: !1, template: { caret: '<span class="caret"></span>' }, maxOptions: !1, mobile: !1, selectOnTab: !1, dropdownAlignRight: !1, windowPadding: 0, virtualScroll: 600, display: !1 }, "4" === _.major && (u.DEFAULTS.style = "btn-light", u.DEFAULTS.iconBase = "", u.DEFAULTS.tickIcon = "bs-ok-default"), u.prototype = {
            ...
            init: function() {
                ...
                }), this.$menu.data("this", this), this.$newElement.data("this", this), this.options.mobile && this.mobile(), this.$newElement.on({ "hide.bs.dropdown": function(e) { i.$menuInner.attr("aria-expanded", !1), i.$element.trigger("hide" + L, e) }, "hidden.bs.dropdown": function(e) { i.$element.trigger("hidden" + L, e) }, "show.bs.dropdown": function(e) { i.$menuInner.attr("aria-expanded", !0), i.$element.trigger("show" + L, e) }, "shown.bs.dropdown": function(e) { i.$element.trigger("shown" + L, e) } }), i.$element[0].hasAttribute("required") && this.$element.on("invalid", function() { i.$button.addClass("bs-invalid"), i.$element.on("shown" + L + ".invalid", function() { i.$element.val(i.$element.val()).off("shown" + L + ".invalid") }).on("rendered" + L, function() { this.validity.valid && i.$button.removeClass("bs-invalid"), i.$element.off("rendered" + L) }), i.$button.on("blur" + L, function() { i.$element.focus().blur(), i.$button.off("blur" + L) }) }), setTimeout(function() { i.$element.trigger("loaded" + L) })
            },
            ...
            createView: function(C, e) {
                ...
                this.setPositionData(), i(e, !0), this.$menuInner.off("scroll.createView").on("scroll.createView", function(e, t) { O.noScroll || i(this.scrollTop, t), O.noScroll = !1 }), F(window).off("resize" + L + "." + this.selectId + ".createView").on("resize" + L + "." + this.selectId + ".createView", function() { O.$newElement.hasClass(q.SHOW) && i(O.$menuInner[0].scrollTop) })
            },
            createLi: function() {
                var z, T = this,
                    D = [],
                ...
                var e, W = { span: document.createElement("span"), subtext: document.createElement("small"), a: document.createElement("a"), li: document.createElement("li"), whitespace: document.createTextNode("\xa0") },
                ...
                var M = function(e, t, i) { var s = W.li.cloneNode(!1); return e && (1 === e.nodeType || 11 === e.nodeType ? s.appendChild(e) : s.innerHTML = e), void 0 !== t && "" !== t && (s.className = t), null != i && s.classList.add("optgroup-" + i), s },
                ...
                j.each(function(e) {
                    ...
                    if (R++, !t.hasClass("bs-title-option")) {
                        var i, s, n = t.data(),
                            ...
                            b = p.data();
                        if (!0 === n.hidden || T.options.hideDisabled && (v && !f || m)) { i = n.prevHiddenIndex, t.next().data("prevHiddenIndex", void 0 !== i ? i : e), R--, g || void 0 !== i && (y = j[i].previousElementSibling) && "OPTGROUP" === y.tagName && !y.disabled && (g = !0), g && "divider" !== L[L.length - 1].type && (R++, D.push(M(!1, q.DIVIDER, N + "div")), L.push({ type: "divider", optID: N })) } else {
                            if (f && !0 !== n.divider) {
                                ...
                                if (!this.previousElementSibling) {
                                    ...
                                    var x = u.label,
                                        ...
                                        $ = b.subtext,
                                        S = b.icon;
                                    0 !== e && 0 < D.length && (R++, D.push(M(!1, q.DIVIDER, N + "div")), L.push({ type: "divider", optID: N })), R++;
                                    var E = function(e) {
                                        var t, i, s = W.text.cloneNode(!1);
                                    ...
                                    }({ labelEscaped: k, labelSubtext: $, labelIcon: S });
                                    D.push(M(E, "dropdown-header" + I, N)), L.push({ content: k, subtext: $, type: "optgroup-label", optID: N }), P = R - 1
                                }
                                if (T.options.hideDisabled && v || !0 === n.hidden) return void R--;
                                s = V({ text: a, optionContent: r, optionSubtext: d, optionIcon: h }), D.push(M(U(s, "opt " + o + I, l), "", N)), L.push({ content: r || a, subtext: d, tokens: c, type: "option", optID: N, headerIndex: P, lastIndex: P + u.childElementCount, originalIndex: e, data: n }), H++
                            } else if (!0 === n.divider) D.push(M(!1, q.DIVIDER)), L.push({ type: "divider", originalIndex: e, data: n });
                            else {
                                var y;
                                if (!g && T.options.hideDisabled)
                                    if (void 0 !== (i = n.prevHiddenIndex))(y = j[i].previousElementSibling) && "OPTGROUP" === y.tagName && !y.disabled && (g = !0);
                                g && "divider" !== L[L.length - 1].type && (R++, D.push(M(!1, q.DIVIDER, N + "div")), L.push({ type: "divider", optID: N })), s = V({ text: a, optionContent: r, optionSubtext: d, optionIcon: h }), D.push(M(U(s, o, l))), L.push({ content: r || a, subtext: d, tokens: c, type: "option", originalIndex: e, data: n }), H++
                            }
            ...
            liHeight: function(e) {
                if (e || !1 !== this.options.size && !this.sizeInfo) {
                    ...
                    var v, g = a.offsetHeight,
                        ...
                        E = i.offsetWidth,
                        y = S ? null : F(i),
                        C = { vert: z(S ? S.paddingTop : y.css("paddingTop")) + z(S ? S.paddingBottom : y.css("paddingBottom")) + z(S ? S.borderTopWidth : y.css("borderTopWidth")) + z(S ? S.borderBottomWidth : y.css("borderBottomWidth")), horiz: z(S ? S.paddingLeft : y.css("paddingLeft")) + z(S ? S.paddingRight : y.css("paddingRight")) + z(S ? S.borderLeftWidth : y.css("borderLeftWidth")) + z(S ? S.borderRightWidth : y.css("borderRightWidth")) },
                        O = { vert: C.vert + z(S ? S.marginTop : y.css("marginTop")) + z(S ? S.marginBottom : y.css("marginBottom")) + 2, horiz: C.horiz + z(S ? S.marginLeft : y.css("marginLeft")) + z(S ? S.marginRight : y.css("marginRight")) + 2 };
            ...
            selectPosition: function() {
                ...
                this.$button.on("click.bs.dropdown.data-api", function() { l.isDisabled() || (e(l.$newElement), l.$bsContainer.appendTo(l.options.container).toggleClass(q.SHOW, !l.$button.hasClass(q.SHOW)).append(l.$menu)) }), F(window).off("resize" + L + "." + this.selectId + " scroll" + L + "." + this.selectId).on("resize" + L + "." + this.selectId + " scroll" + L + "." + this.selectId, function() { l.$newElement.hasClass(q.SHOW) && e(l.$newElement) }), this.$element.on("hide" + L, function() { l.$menu.data("height", l.$menu.height()), l.$bsContainer.detach() })
            },
            ...
            clickListener: function() {
                ...
                function e() { S.options.liveSearch ? S.$searchbox.focus() : S.$menuInner.focus() }

                function i() { S.dropdown && S.dropdown._popper && S.dropdown._popper.state.isCreated ? e() : requestAnimationFrame(i) }
                        ...
                        if (n === S.activeIndex && (t = !0), t || (S.prevActiveIndex = S.activeIndex, S.activeIndex = void 0), S.multiple) {
                            if (c.prop("selected", !d), S.setSelected(n, !d), i.blur(), !1 !== u || !1 !== f) {
                                ...
                                if (u && m || f && v)
                                    ...
                                    I[2] && (x = x.replace("{var}", I[2][1 < u ? 0 : 1]), k = k.replace("{var}", I[2][1 < f ? 0 : 1])), c.prop("selected", !1), S.$menu.append($), u && m && ($.append(F("<div>" + x + "</div>")), r = !1, S.$element.trigger("maxReached" + L)), f && v && ($.append(F("<div>" + k + "</div>")), r = !1, S.$element.trigger("maxReachedGrp" + L)), setTimeout(function() { S.setSelected(n, !1) }, 10), $.delay(750).fadeOut(300, function() { F(this).remove() })
                                }
                            }
            ...
            destroy: function() { this.$newElement.before(this.$element).remove(), this.$bsContainer ? this.$bsContainer.remove() : this.$menu.remove(), this.$element.off(L).removeData("selectpicker").removeClass("bs-select-hidden selectpicker"), F(window).off(L + "." + this.selectId) }
        };
        var g = F.fn.selectpicker;
        F.fn.selectpicker = v, F.fn.selectpicker.Constructor = u, F.fn.selectpicker.noConflict = function() { return F.fn.selectpicker = g, this }, F(document).off("keydown.bs.dropdown.data-api").on("keydown" + L, '.bootstrap-select [data-toggle="dropdown"], .bootstrap-select [role="listbox"], .bootstrap-select .bs-searchbox input', u.prototype.keydown).on("focusin.modal", '.bootstrap-select [data-toggle="dropdown"], .bootstrap-select [role="listbox"], .bootstrap-select .bs-searchbox input', function(e) { e.stopPropagation() }), F(window).on("load" + L + ".data-api", function() {
